...
extension_length = 8e-6; // Source/drain extensions
bulk_height      = 5e-5; // Bulk depth
oxide_thickness  = 1e-6; // Gate oxide thickness
source_contact   = 1e-5; // Source width
drain_contact    = 1e-5; // Drain width

// Mesh Densities
fine_mesh   = 1e-6; // Fine mesh size
...
Point(7) = {source_contact, bulk_height + oxide_thickness, 0, fine_mesh}; // Top-left oxide
Point(8) = {source_contact + oxide_width, bulk_height + oxide_thickness, 0, fine_mesh}; // Top-right oxide
